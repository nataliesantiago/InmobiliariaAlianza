			...
			<!-- Nav -->
				<nav id="nav">
					...
					<form class="form login-form">
							...
							<br>
							<a href="#" class="button alt2">Buscar</a>
							<br>
							...
							<div class="well">
								<form class="form login-form">
									...
									<div>
										...
										<center><input type="checkbox" id="RememberMe" value="option1">Recordar</center> 
										</label>
										<br />
										</center>
										<center><button type="submit" class="btn2 btn-default">Ingresar</button></center>
										<br />
										<center>
											<ul class="social">
