                ...
                <div class="4u 12u(mobile)">
                    <section class="box">
                        <div class="well">
                            ...
                            <br>
                                <div><a href="/academic_event">Búsqueda avanzada</a></div>
                            </form>
                        </div>
                    </section>
                </div>
                ...
                <div class="4u 12u(mobile)">
                        ...
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div>
                                        ...
                                        <center><input type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>"></center>
                                    ...
                                    <HR>
                                    <center><a class="forgot btn-link" href="<?php echo e(url('/password/reset')); ?>">¿Olvido su contraseña?</a></center>
                                </form>
                            </div>
                            <hr >       
                        </section>
