CREATE OR REPLACE TABLE USER(
	...
	CONTACT					VARCHAR(200) CHARACTER SET utf8 COLLATE utf8_spanish_ci,
	ACADEMIC_INSTITUTION	INT NOT NULL,
	TYPE			INT NOT NULL,
	PRIMARY KEY(USERNAME),
	FOREIGN KEY(TYPE) REFERENCES TYPE_OF_USER(ID),
	FOREIGN KEY(ACADEMIC_INSTITUTION) REFERENCES ACADEMIC_INSTITUTION(ID)
