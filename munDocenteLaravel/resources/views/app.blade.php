...
@stop
	...
	@section('content')		
               ...
               @if($publication->user->academic_institution==1)
                ...
                <img class="col-xs-2" src="images/nacional.png" > 
                @endif
                    @if($publication->user->academic_institution==3)
                <img class="col-xs-2" src="images/sena.png" > 
                @endif
                    @if($publication->user->academic_institution==4)
                <img class="col-xs-2" src="" > 
                @endif
                    @if($publication->user->academic_institution==5)
                <img class="col-xs-2" src="images/uniboy.png" > 
                @endif
                    @if($publication->user->academic_institution==6)
                <img class="col-xs-2" src="images/uis.png" > 
                @endif
                    @if($publication->user->academic_institution==7)
                <img class="col-xs-2" src="images/antioquia.png" > 
                @endif
                    @if($publication->user->academic_institution==8)
                <img class="col-xs-2" src="images/pereira.png" > 
                @endif
                    @if($publication->user->academic_institution==9)
                <img class="col-xs-2" src="images/caldas.png" > 
                @endif
                    @if($publication->user->academic_institution==10)
                <img class="col-xs-2" src="images/medellin.png" > 
                @endif
                    @if($publication->user->academic_institution==11)
                <img class="col-xs-2" src="images/eafit.png" > 
                @endif
