	...
	<?php foreach($publications as $publication): ?>
		<section id="one" class="wrapper style3">
			<div class="inner">
				<div class="content">
					<time class="published" datetime="2016-05-01">Fecha publicación: <?php echo e($publication->date_publication); ?></time>
					<h2 class="major"><?php echo e($publication->name); ?></h2>
					<h4 class><time class="published" datetime="2016-05-01">Fecha de inicio: <?php echo e($publication->start_date); ?></time></h4>
					<h4 class>Institución: falta relacionar al publicador</h4>
					<h4 class>Publicador: <?php echo e($publication->username); ?></h4>
					<h4 class><?php echo e($publication->place); ?></h4>
					<h4 class>Area(s): son agregadas pro el publicador</h4>
					<a href="http://www.ccb.org.co">Url externa: <?php echo e($publication->url); ?></a>
					<h1></h1>
					<ul class="stats">
